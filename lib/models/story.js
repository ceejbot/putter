...
//----------------------------------------------------------------------
var Story = polyclay.Model.buildClass(
{
    properties:
    {
...
Story.byOwner = function(id, callback)
{
    if (typeof id === 'object')
        id = id.key;

    Story.adapter.db.view('stories/by_owner', { key: id }, function(err, documents)
    {
